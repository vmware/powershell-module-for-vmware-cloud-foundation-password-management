...
```powershell
Request-NsxtEdgePasswordComplexity -server <fqdn> -user <admin_username> -pass <admin_password> -domain <workload_domain_name>
```
...
```powershell
Request-NsxtEdgePasswordComplexity -server <fqdn> -user <admin_username> -pass <admin_password> -domain <workload_domain_name> -drift -reportPath <report_path> -policyFile <policy_file>.json
```
...
```powershell
Request-NsxtEdgePasswordComplexity -server <fqdn> -user <admin_username> -pass <admin_password> -domain <workload_domain_name> -unmanagedEdgeNode <vm_name> -unmanagedEdgeNodePass <admin_password>
```
