...
```powershell
Request-WsaLocalUserAccountLockout -server <fqdn> -user <admin_username> -pass <admin_password> -wsaFqdn <fqdn> -wsaRootPass <root_password>
```
...
```powershell
Request-WsaLocalUserAccountLockout -server <fqdn> -user <admin_username> -pass <admin_password> -wsaFqdn <fqdn> -wsaRootPass <root_password> -drift -reportPath <report_path> -policyFile <policy_file>.json
```
...
```powershell
Request-WsaLocalUserAccountLockout -server <fqdn> -user <admin_username> -pass <admin_password> -wsaFqdn <fqdn> -wsaRootPass <root_password> -drift
```
