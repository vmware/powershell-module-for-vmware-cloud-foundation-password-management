...
```powershell
Publish-NsxEdgeAccountLockout -server <String> -user <String> -pass <String> [-allDomains] [-drift]
...
```powershell
Publish-NsxEdgeAccountLockout -server <String> -user <String> -pass <String> -workloadDomain <String> [-drift]
 [-reportPath <String>] [-policyFile <String>] [-json] [<CommonParameters>]
```
