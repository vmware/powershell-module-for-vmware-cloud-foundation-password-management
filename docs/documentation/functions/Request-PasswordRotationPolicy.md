...
```powershell
Request-PasswordRotationPolicy -server <fqdn> -user <admin_username> -pass <admin_password>
```
...
```powershell
Request-PasswordRotationPolicy -server <fqdn> -user <admin_username> -pass <admin_password> -domain <workload_domain_name>
```
...
```powershell
Request-PasswordRotationPolicy -server <fqdn> -user <admin_username> -pass <admin_password> -resource nsxManager
```
...
```powershell
Request-PasswordRotationPolicy -server <fqdn> -user <admin_username> -pass <admin_password> -domain <workload_domain_name> -resource nsxManager
```
