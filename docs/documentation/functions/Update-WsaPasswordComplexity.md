...
```powershell
Update-WsaPasswordComplexity -server <fqdn> -user <admin_username> -pass <admin_password> -minLength 15 -minLowercase 1 -minUppercase 1 -minNumeric 1 -minSpecial 1 -maxIdenticalAdjacent 1 -maxPreviousCharacters 0 -history 5
```
