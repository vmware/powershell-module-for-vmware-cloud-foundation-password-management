...
```powershell
Update-SddcManagerPasswordComplexity -server <fqdn> -user <admin_username> -pass <admin_password> -rootPass <root_password> -minLength 6 -minLowercase -1 -minUppercase -1  -minNumerical -1 -minSpecial -1 -minUnique 4 -minClass 4 -maxSequence 0 -history 5 -maxRetry 3
```
