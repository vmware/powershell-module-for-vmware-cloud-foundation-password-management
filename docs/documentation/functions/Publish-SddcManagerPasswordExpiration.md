...
```powershell
Publish-SddcManagerPasswordExpiration -server <fqdn> -user <admin_username> -pass <admin_password> -sddcRootPass <root_password> -allDomains
```
...
```powershell
Publish-SddcManagerPasswordExpiration -server <fqdn> -user <admin_username> -pass <admin_password> -sddcRootPass <root_password> -workloadDomain <workload_domain_name>
```
...
```powershell
Publish-SddcManagerPasswordExpiration -server <fqdn> -user <admin_username> -pass <admin_password> -sddcRootPass <root_password> -workloadDomain <workload_domain_name> -drift -reportPath <report_path> -policyFile <policy_file>.json
```
...
```powershell
Publish-SddcManagerPasswordExpiration -server <fqdn> -user <admin_username> -pass <admin_password> -sddcRootPass <root_password> -workloadDomain <workload_domain_name> -drift
```
