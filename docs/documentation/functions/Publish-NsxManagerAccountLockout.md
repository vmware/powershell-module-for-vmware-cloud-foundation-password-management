...
```powershell
Publish-NsxManagerAccountLockout -server <String> -user <String> -pass <String> [-allDomains] [-drift]
...
```powershell
Publish-NsxManagerAccountLockout -server <String> -user <String> -pass <String> -workloadDomain <String>
